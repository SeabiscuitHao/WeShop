...
class UserToken {
  ...
  private function saveToCate($cachedValue) {
  ...
  //准备缓存
  private function prapareCachedValue($wxResult,$uid) {
    $cachedValue = $wxResult;
    $cachedValue['uid'] = $uid;
    //scope作用域，值越大，权限越高

    //scope = 32 CMS 用户的权限数值
    //scope = 16 App 用户的权限数值
    // 枚举
